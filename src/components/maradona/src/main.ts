...
fbxLoader.load('models/maradona_con_palla.fbx',
  (model) => {
    ...
    materials.forEach(material => {
if (material.name === 'divisa' || material.name === 'colletto_ai' || material.name === 'maglietta_ai' || material.name === 'pantaloncini_ai' || material.name === 'gambe_ai') {
      ...
      if (material.name === 'pelle_ai1' || material.name === 'pelle_ai' || material.name === 'occhi_ai') {
...
function loadCampoTextures(){
    ...
    stadioEmissive = textureLoader.load('textures/stadio/STADIO01_Emissive.png')
    stadioHeight = textureLoader.load('textures/stadio/STADIO01_Height.png')
    stadioMetallic = textureLoader.load('textures/stadio/STADIO01_Metallic.png')
