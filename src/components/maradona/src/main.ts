...
export function initScene(container: HTMLElement) {
  ...
  //   .add(directionalLight.position, "x", -200, 200, 0.01)
  //   .onChange(updateHelper);
  // directionalLightFolder
  //   .add(directionalLight.position, "y", -200, 200, 0.01)
  //   .onChange(updateHelper);
  // directionalLightFolder
  //   .add(directionalLight.position, "z", -200, 200, 0.01)
  //   .onChange(updateHelper);
  ...
  // wireframeMatFolder.add(materia const directionalLightFolder = gui.addFolder("Directional Light");lLibrary["wireMat"], "opacity", 0, 1, 0.1);
